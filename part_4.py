...
class PDF(FPDF):
    ...
    def header(self):
        ...
        # Calculate the width of the title and position
        title_w = self.get_string_width(title) + 6
        doc_w = self.w
        self.set_x((doc_w-title_w)/2)

        # Set color of frame, background and text
        ...
        # Title
        self.cell(title_w,10,title, border=True, ln=1, align='C',fill=1)
    ...
    # adding chapter title to start to each chapter
...
pdf.cell(0, 10, "Chapter 1", ln=1, link=ch2_link)
